...
export BUFFER_SIZE=30000
export BEGIN_LEARNING_AT_STEP=20000
export N_UPDATE_STEPS=8
export BATCHSIZE=32
export UPDATE_FREQ=64
export N_PREV_FRAMES=12
export LEARNING_RATE_Q=1e-1

export SAVEDIR=results/pong_ddpg_stable/lrq${LEARNING_RATE_Q}_npf${N_PREV_FRAMES}_momentum0.2_nesterov_alpha2_frzn_prioritized_large_buffer
